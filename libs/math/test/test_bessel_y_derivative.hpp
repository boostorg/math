...
void test_bessel_derivative(T, const char* name)
{
   ...
   // 
    ...
    static const boost::array<boost::array<typename table_type<T>::type, 3>, 9> y0_derivative_data = {{
        ...
        {{ SC_(0), SC_(8), SC_(0.15806046173124749425555526618748355032734404952671) }},
        {{ SC_(0), SC_(1e-05), SC_(63661.97727536548515747484843924772510915025447869) }},
        {{ SC_(0), SC_(1e-10), SC_(6.366197723675813431507891842844626117090808311905e9) }},
        {{ SC_(0), SC_(1e-20), SC_(6.366197723675813430755350534900574482790569176554e19) }},
    ...
    static const boost::array<boost::array<typename table_type<T>::type, 3>, 9> y1_derivative_data = {{
        ...
        {{ SC_(1), SC_(8), SC_(0.24327904710397215730926780877205580306573293697226) }},
        {{ SC_(1), SC_(1e-10), SC_(6.366197723675813430034640215574901912821641347643e19) }},
        {{ SC_(1), SC_(1e-20), SC_(6.366197723675813430755350534900574481363849370436e39) }},
        {{ SC_(1), SC_(1e+01), SC_(0.030769624862904003032131529943867767819086460209939) }},
    ...
    static const boost::array<boost::array<typename table_type<T>::type, 3>, 10> yn_derivative_data = {{
        ...
        {{ SC_(10), SC_(10), SC_(0.16051488637815838440809874678012991818716553338993) }},
        {{ SC_(10), SC_(1e-10), SC_(1.1828049049433493390095436658120487349235941485975e119) }},
        {{ SC_(-10), SC_(1e+06), SC_(-0.00033107967471992097725245404942310474516318425) }},
        {{ SC_(1e+02), SC_(5), SC_(1.0156878983956300357005118672219842696133568692723e117) }},
    ...
    static const boost::array<boost::array<T, 3>, 7> yv_derivative_large_data = {{
        ...
        {{ SC_(-0.5), static_cast<T>(std::ldexp(0.5, -683)), SC_(-2.8687031947358903207339089001240304482394770756064275336724208525796188866274e308) }},
