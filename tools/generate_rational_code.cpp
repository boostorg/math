...
void print_polynomials(int max_order)
{
   for(int i = 2; i <= max_order; ++i)
   {
      ...
      ofs << copyright_string <<
         ...
         "constexpr BOOST_MATH_HOST_DEVICE V evaluate_polynomial_c_imp(const T*, const V&, const std::integral_constant<int, 0>*)\n"
         "{\n"
         "   return static_cast<V>(0);\n"
         "}\n"
         "\n"
         "template <class T, class V>\n"
         "constexpr BOOST_MATH_HOST_DEVICE V evaluate_polynomial_c_imp(const T* a, const V&, const std::integral_constant<int, 1>*)\n"
         "{\n"
      ...
      for(int order = 2; order <= i; ++order)
      {
         ofs << 
         "template <class T, class V>\n"
         "constexpr BOOST_MATH_HOST_DEVICE V evaluate_polynomial_c_imp(const T* a, const V& x, const std::integral_constant<int, " << order << ">*)\n"
         "{\n"
      ...
      ofs << copyright_string <<
         ...
         "}\n\n"
         "template <class T, class V>\n"
         "constexpr BOOST_MATH_HOST_DEVICE V evaluate_polynomial_c_imp(const T* a, const V& x, const std::integral_constant<int, 2>*)\n"
         "{\n"
         "   return static_cast<V>(a[1] * x + a[0]);\n"
         "}\n\n"
         "template <class T, class V>\n"
         "constexpr BOOST_MATH_HOST_DEVICE V evaluate_polynomial_c_imp(const T* a, const V& x, const std::integral_constant<int, 3>*)\n"
         "{\n"
         "   return static_cast<V>((a[2] * x + a[1]) * x + a[0]);\n"
         "}\n\n"
         "template <class T, class V>\n"
         "constexpr BOOST_MATH_HOST_DEVICE V evaluate_polynomial_c_imp(const T* a, const V& x, const std::integral_constant<int, 4>*)\n"
         "{\n"
