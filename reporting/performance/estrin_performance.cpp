...
template<class Real>
void HornerRealCoeffsRealArg(benchmark::State& state)
{
...
template<class Real>
void HornerRealCoeffsComplexArg(benchmark::State& state)
{
    long n = state.range(0);
    std::random_device rd;
    auto seed = rd();
...
template<class Real>
void EstrinRealCoeffsRealArg(benchmark::State& state)
{
    long n = state.range(0);
    std::random_device rd;
    auto seed = rd();
...
template<class Real>
void EstrinRealCoeffsRealArgWithScratch(benchmark::State& state)
{
    long n = state.range(0);
    std::random_device rd;
    auto seed = rd();
...
template<class Real>
void EstrinRealCoeffsComplexArgWithScratch(benchmark::State& state)
{
    long n = state.range(0);
    std::random_device rd;
    auto seed = rd();
...
void EstrinRealCoeffsRealArgStdArray(benchmark::State& state)
{
    std::random_device rd;
    auto seed = rd();
    std::mt19937_64 mt(seed);
