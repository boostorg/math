...
void test_bessel(T, const char* name)
{
    ...
    static const boost::array<boost::array<T, 3>, 10> i0_derivative_data = {{
        ...
        {{ SC_(0), SC_(4), SC_(9.75946515370444990947519256731268090005597033325) }},
        {{ SC_(0), SC_(-7), SC_(-156.039092869955453462390580660711155630031052042) }},
        {{ SC_(0), T(1) / 1024, SC_(0.000488281308207663226432087816784315537514225208473395) }},
        {{ SC_(0), T(SC_(1)) / (1024*1024), SC_(4.76837158203179210108624277276025646653133998635957e-7) }},
        {{ SC_(0), SC_(-1), SC_(-0.565159103992485027207696027609863307328899621621) }},
    ...
    static const boost::array<boost::array<T, 3>, 10> i1_derivative_data = {{
        ...
        {{ SC_(1), SC_(4), SC_(8.86205566371021801898747204138893227239862401112) }},
        {{ SC_(1), SC_(-8), SC_(377.579973623984772900011405549855040764360549303) }},
        {{ SC_(1), T(SC_(1))/1024, SC_(0.500000178813946168551133736709856567600996119560422) }},
        {{ SC_(1), T(SC_(1))/(1024*1024), SC_(0.500000000000170530256582434815189962442052310320626) }},
        {{ SC_(1), SC_(-10), SC_(2548.6177980961290060357079567493748381638767230173) }},
    ...
    static const boost::array<boost::array<T, 3>, 11> in_derivative_data = {{
        ...
        {{ SC_(-5), SC_(100), SC_(9.434574089052212641696648538570565739509851953166e41) }},
        {{ SC_(-5), SC_(-1), SC_(0.001379804441262006949232714689824343061461150959112) }},
        {{ SC_(10), SC_(20), SC_(3.887291476282816593964936516887942731146400030466e6) }},
        {{ SC_(10), SC_(-5), SC_(-0.0101556299784624552653083645193223022003797137770) }},
        {{ SC_(1e+02), SC_(9), SC_(3.0600487816519872979909028718737622834061708443e-92) }},
        {{ SC_(1e+02), SC_(80), SC_(7.43545006374466980237328068214707549314834217923e8) }},
    ...
    static const boost::array<boost::array<T, 3>, 10> iv_derivative_data = {{
        ...
        {{ SC_(-5.5), SC_(10), SC_(659.1902595786901927596924259811320437384361101) }},
        {{ SC_(-5.5), SC_(100), SC_(9.191476042191556775282339209385028823905941708e41) }},
        {{ T(-10486074)/(1024*1024), T(1)/1024, SC_(-1.44873720736417608945635957884937466861026978539e39) }},
        {{ T(-10486074)/(1024*1024), SC_(50), SC_(1.082410021443599516897183930739816215073642812109e20) }},
        {{ T(144794)/1024, SC_(100), SC_(3575.11008553328328036816705258135747714241715202) }},
