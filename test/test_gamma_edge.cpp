...
namespace local
{
  ...
  auto lgamma_big_asymp() -> void
  {
    ...
    const local_float_type ctrl0 { BOOST_MATH_HUGE_CONSTANT(local_float_type, 7551.) };
    const local_float_type ctrl1 { BOOST_MATH_HUGE_CONSTANT(local_float_type, 7551.) };
    const local_float_type ctrl2 { BOOST_MATH_HUGE_CONSTANT(local_float_type, 7551.) };
    const local_float_type ctrl3 { BOOST_MATH_HUGE_CONSTANT(local_float_type, 7551.) };
