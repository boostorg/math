...
void test_spots6(T, const char* type_name)
{
   static const boost::array<boost::array<T, 4>, 57> hypergeometric_1F1_bugs = { {
        ...
        { { SC_(-8.1104991963343309e-05), SC_(-1.0000811049919633), SC_(-289.12455415725708), SC_(7.8949781467741574268884621364833028722017032e-124) }},
         ...
         { { SC_(-7.8238229420435346e-05), SC_(-0.50007823822942044), SC_(-1896.0561106204987), SC_(1.00058778866237037053151236215058095904086972) }},

         // Unexpected high error : 2.48268e+91 Found : -9.61305e+268 Expected : -1.74382e+193
         { { SC_(5.9981750131794866e-15), SC_(-230.70702263712883), SC_(240.42092034220695), SC_(-1.74381782591884817018404492963109914357365958e+193) }},
         ...
         { { SC_(-5.9981750131794866e-15), SC_(-230.70702263712883), SC_(240.42092034220695), SC_(1.74381782591870734495565763481520223752372107e+193) }},
         ...
         { { SC_(-0.00023636552788275367), SC_(0.49976363447211725), SC_(-55.448519088327885), SC_(1.00141219419064760011631555641142295011268795) }},
         // Unexpected exception: Error in function boost::math::hypergeometric_pFq<long double>: Cancellation is so severe that no bits in the reuslt are correct, last result was -13497.312248525042
         {{ SC_(-0.00023636552788275367), SC_(-0.50023636552788275), SC_(-55.448519088327885), SC_(1.00093463146763986302362749764017215184711625) }},
         ...
         { { SC_(-1.6548533913638905e-10), SC_(0.49999999983451465), SC_(-169.20843148231506), SC_(1.00000000117356793527360151094991866549128017) }},
         // Unexpected exception: Error in function boost::math::hypergeometric_pFq<long double>: Cancellation is so severe that no bits in the reuslt are correct, last result was -1.3871133003351527e+47
         {{ SC_(-1.6548533913638905e-10), SC_(-0.50000000016548529), SC_(-169.20843148231506), SC_(1.00000000084161045914716192484600809610013447) }},
         ...
         { { SC_(-2.0211181797563725e-14), SC_(-1.0000000000000202), SC_(-25.653068032115698), SC_(-0.000253525216374277055047768086884693917115210113) }},
         // Unexpected high error: 1.79769e+308 Found: -inf Expected: -2.63233e-197
         {{ SC_(235.44106131792068), SC_(-2.250966744069919e-13), SC_(-974.28781914710999), SC_(-2.63233018990922939037251029961929844581862228e-197) }},
         ...
         { { SC_(-235.44106131792068), SC_(-2.250966744069919e-13), SC_(974.28781914710999), SC_(-3.53316570137147343919975579872097464691424847e+226) }},
         // Unexpected high error : 2.48268e+91 Found : -9.61305e+268 Expected : -1.74382e+193
         { { SC_(5.9981750131794866e-15), SC_(-230.70702263712883), SC_(240.42092034220695), SC_(-1.74381782591884817018404492963109914357365958e+193) }},
         // Unexpected high error : 1.79769313486231570814527423731704356798070568e+308 Found : -9.61305077326281580724540507004198316499661687e+268 Expected : 1.74381782591870724567837900957146707932623893e+193
         { { SC_(-5.9981750131794866e-15), SC_(-230.70702263712883), SC_(240.42092034220695), SC_(1.74381782591870734495565763481520223752372107e+193) }},
         ...
         { { SC_(6.772927684190258e-10), SC_(-0.99999999932270722), SC_(-483.69576895236969), SC_(1.32865406166941679958876322759721528297325713e-08) }},
         // Unexpected high error: 1.79769e+308 Found: -nan(ind) Expected: 5.31173e-38
         {{ SC_(6763.4877452850342), SC_(3.6834977949762315e-08), SC_(-210.20976513624191), SC_(5.31173132667573457976877380237496445775181141e-38) }},
         ...
         { { SC_(-6763.4877452850342), SC_(3.6834977949762315e-08), SC_(210.20976513624191), SC_(1.04274264437409861991447530452939035771734596e+54) }},
         ...
         {{ SC_(5.6136137469239618e-15), SC_(-0.99999999999999434), SC_(-1989.8742001056671), SC_(0.00856985180985659334965068576732515544478559175) }},
         ...
         { { SC_(-5.6136137469239618e-15), SC_(-0.50000000000000566), SC_(-1989.8742001056671), SC_(1.00000000000004243096226509338784935080089269) }},
   } };
   static const boost::array<boost::array<T, 4>, 2> hypergeometric_1F1_big_bugs = { {
         {{ SC_(7.8238229420435346e-05), SC_(-5485.3222503662109), SC_(1896.0561106204987), BOOST_MATH_HUGE_CONSTANT(T, 1000, 4.33129800901478785957996719992774682013355926e+668) }},
         {{ SC_(-7.8238229420435346e-05), SC_(-5485.3222503662109), SC_(1896.0561106204987), BOOST_MATH_HUGE_CONSTANT(T, 1000, 4.3248750673398590673783317624407455467680038e+668) }},
   } };
