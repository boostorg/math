...
bool test_tgamma_for_issue396_cpp_dec_float()
{
  ...
  const bool cpp_dec_float_020_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_020>();
  const bool cpp_dec_float_030_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_030>();
  const bool cpp_dec_float_040_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_040>();
  const bool cpp_dec_float_049_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_049>();
  const bool cpp_dec_float_050_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_050>();
  const bool cpp_dec_float_051_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_051>();
  const bool cpp_dec_float_101_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_101>();
  const bool cpp_dec_float_501_is_ok = boost::math::detail::test_issue396_value_checker<cpp_dec_float_type_501>();
