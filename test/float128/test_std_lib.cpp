...
BOOST_AUTO_TEST_CASE( test_main )
{
   ...
   // N[(-25/10)^((25/10)+((35/10) I)), 64]
   BOOST_CHECK_CLOSE_FRACTION(real(pow(BOOST_FLOATMAX_C(-2.5), cm)), BOOST_FLOATMAX_C(0.0000108384213983921628818716620216475625862428265426558408687988615), tol);
