...
void instantiate(RealType)
{
   ...
   boost::math::cyl_neumann_derivative(v1, v2);
   boost::math::cyl_neumann_derivative(i, v2);
   boost::math::cyl_bessel_j_derivative(v1, v2);
   boost::math::cyl_bessel_j_derivative(i, v2);
   boost::math::cyl_bessel_i_derivative(v1, v2);
   boost::math::cyl_bessel_i_derivative(i, v2);
   boost::math::cyl_bessel_k_derivative(v1, v2);
   boost::math::cyl_bessel_k_derivative(i, v2);
   boost::math::sph_bessel_derivative(i, v2);
   boost::math::sph_bessel_derivative(i, 1);
   boost::math::sph_neumann_derivative(i, v2);
   boost::math::sph_neumann_derivative(i, i);
   ...
   boost::math::sph_neumann(i, i);
   boost::math::cyl_neumann_derivative(v1 * 1, v2 + 0);
   boost::math::cyl_neumann_derivative(i, v2 * 1);
   boost::math::cyl_bessel_j_derivative(v1 * 1, v2 + 0);
   boost::math::cyl_bessel_j_derivative(i, v2 * 1);
   boost::math::cyl_bessel_i_derivative(v1 * 1, v2 + 0);
   boost::math::cyl_bessel_i_derivative(i, v2 * 1);
   boost::math::cyl_bessel_k_derivative(v1 * 1, v2 + 0);
   boost::math::cyl_bessel_k_derivative(i, v2 * 1);
   boost::math::sph_bessel_derivative(i, v2 * 1);
   boost::math::sph_bessel_derivative(i, 1);
   boost::math::sph_neumann_derivative(i, v2 * 1);
   boost::math::sph_neumann_derivative(i, i);
   ...
   boost::math::cyl_neumann_derivative(v1, v2, pol);
   boost::math::cyl_neumann_derivative(i, v2, pol);
   boost::math::cyl_bessel_j_derivative(v1, v2, pol);
   boost::math::cyl_bessel_j_derivative(i, v2, pol);
   boost::math::cyl_bessel_i_derivative(v1, v2, pol);
   boost::math::cyl_bessel_i_derivative(i, v2, pol);
   boost::math::cyl_bessel_k_derivative(v1, v2, pol);
   boost::math::cyl_bessel_k_derivative(i, v2, pol);
   boost::math::sph_bessel_derivative(i, v2, pol);
   boost::math::sph_bessel_derivative(i, 1, pol);
   boost::math::sph_neumann_derivative(i, v2, pol);
   boost::math::sph_neumann_derivative(i, i, pol);
   ...
   test::cyl_neumann_derivative(v1, v2);
   test::cyl_neumann_derivative(i, v2);
   test::cyl_bessel_j_derivative(v1, v2);
   test::cyl_bessel_j_derivative(i, v2);
   test::cyl_bessel_i_derivative(v1, v2);
   test::cyl_bessel_i_derivative(i, v2);
   test::cyl_bessel_k_derivative(v1, v2);
   test::cyl_bessel_k_derivative(i, v2);
   test::sph_bessel_derivative(i, v2);
   test::sph_bessel_derivative(i, 1);
   test::sph_neumann_derivative(i, v2);
   test::sph_neumann_derivative(i, i);
...
void instantiate_mixed(RealType)
{
   ...
   boost::math::sph_neumann(i, i);
   boost::math::cyl_neumann_derivative(fr, dr);
   boost::math::cyl_neumann_derivative(i, s);
   boost::math::cyl_bessel_j_derivative(fr, lr);
   boost::math::cyl_bessel_j_derivative(i, s);
   boost::math::cyl_bessel_i_derivative(fr, lr);
   boost::math::cyl_bessel_i_derivative(i, s);
   boost::math::cyl_bessel_k_derivative(fr, lr);
   boost::math::cyl_bessel_k_derivative(i, s);
   boost::math::sph_bessel_derivative(i, fr);
   boost::math::sph_bessel_derivative(i, 1);
   boost::math::sph_neumann_derivative(i, lr);
   boost::math::sph_neumann_derivative(i, i);
   ...
   boost::math::sph_neumann(i, i, pol);
   boost::math::cyl_neumann_derivative(fr, dr, pol);
   boost::math::cyl_neumann_derivative(i, s, pol);
   boost::math::cyl_bessel_j_derivative(fr, lr, pol);
   boost::math::cyl_bessel_j_derivative(i, s, pol);
   boost::math::cyl_bessel_i_derivative(fr, lr, pol);
   boost::math::cyl_bessel_i_derivative(i, s, pol);
   boost::math::cyl_bessel_k_derivative(fr, lr, pol);
   boost::math::cyl_bessel_k_derivative(i, s, pol);
   boost::math::sph_bessel_derivative(i, fr, pol);
   boost::math::sph_bessel_derivative(i, 1, pol);
   boost::math::sph_neumann_derivative(i, lr, pol);
   boost::math::sph_neumann_derivative(i, i, pol);
   ...
   test::sph_neumann(i, i);
   test::cyl_neumann_derivative(fr, dr);
   test::cyl_neumann_derivative(i, s);
   test::cyl_bessel_j_derivative(fr, lr);
   test::cyl_bessel_j_derivative(i, s);
   test::cyl_bessel_i_derivative(fr, lr);
   test::cyl_bessel_i_derivative(i, s);
   test::cyl_bessel_k_derivative(fr, lr);
   test::cyl_bessel_k_derivative(i, s);
   test::sph_bessel_derivative(i, fr);
   test::sph_bessel_derivative(i, 1);
   test::sph_neumann_derivative(i, lr);
   test::sph_neumann_derivative(i, i);
   test::airy_ai(i);
   test::airy_bi(i);
   test::airy_ai_prime(i);
