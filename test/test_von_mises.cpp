...
void test_spots(RealType)
{
  ...
  BOOST_CHECK_CLOSE(
      ...
      static_cast<RealType>(14.10332862065253024470686549675132142170213L), // e^1250/(2*pi*I0(1250)
      tolerance);
  ...
  //
  // Spot checks for mean = -5, conc = 6:
  //
//  for(RealType x = -15; x < 5; x += 0.125)
//  {
//    BOOST_CHECK_CLOSE(
//         pdf(von_mises_distribution<RealType>(-5, 6), x),
...
------ Build started: Project: test_von_mises, Configuration: Release Win32 ------
  test_von_mises.cpp
  Generating code
  Finished generating code
  test_von_mises.vcxproj -> J:\Cpp\MathToolkit\test\Math_test\Release\test_von_mises.exe
  Running 1 test case...
  Tolerance for type float is 0.01 %
  Tolerance for type double is 0.01 %
  Tolerance for type long double is 0.01 %
