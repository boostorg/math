...
T lgamma_small_imp(T z, const mpl::int_<64>&, const L& /* l */)
{
   ...
   else if(z > 2)
   {
      ...
      static const T P[] = {
         ...
         0.0143958199025860583204L,
         -0.978373137456345830688e-4L,
      ...
      static const T Q[] = {
         ...
         0.473755004180581327258L,
         0.0875107462228679604253L,
         0.00764784225322423005505L,
         0.000231755590528634189154L,
   ...
   else
   {
      ...
      if(z <= 1.5)
      {
         ...
         static const T P[] = {
            ...
            -0.406671253150552159867L,
            -0.158485163139370246003L,
         ...
         static const T Q[] = {
            ...
            1.91483668813752378519L,
            0.507405586008314503279L,
            0.0577467640632204596358L,
      ...
      else
      {
         ...
         static const T Q[] = {
            ...
            -0.219534612217764199358L,
            0.0254853435878495030518L,
   ...
   else if(z > 2)
   {
      ...
      if(zm2 <= 0.5)
      {
         ...
         static const T P[] = {
            ...
            0.05611463002021184516545593555451608372L,
            0.01742222964261853063358392622502523747L,
            0.0018158345530614588419850186507970980656L,
            -0.000207649675456994817621224299156933001L,
            -0.60729333710617629393290818140778474095e-4L,
            -0.42193334280034771685583458108916814439e-5L,
         ...
         static const T Q[] = {
            ...
            1.5264037996244929694319810127680846702L,
            0.53667922960167567507127400551403990757L,
            0.11649274210374471800101181978201670265L,
            0.015334547510553253256694861064961493735L,
            0.0011510244538642675635719327775509743305L,
            0.43049800463380576150908486689063642384e-4L,
      ...
      {
         // Maximum Deviation Found (approximation error)         1.184e-36
         // Expected Error Term (theoretical error)               7.387e-37
         // Max error found at 128-bit long double precision      2.171e-36
         //
         static const T P[] = {
            -0.0056332857464317971742887601813131853093L,
            0.021168712057640375105173045111730850833L,
            0.020001311031238872808552866616482997829L,
            0.0032811244055788536417519926776706332117L,
            -0.001153440061104829279624773486026322699L,
            -0.0003509589483151001247564434188312514286L,
            -0.12255255902341760055885103329963154277e-4L,
            0.31518329835588322755221156609008859656e-5L,
            0.23911944363399602286306752084480904182e-6L,
            0.34999722784659830776183464578607962947e-8L
         };
         static const T Q[] = {
            1,
            1.5629234923387340811660668243751340548L,
            0.97260243641385146477048017593774480902L,
            0.30007412668332185425949376918413251682L,
            0.044202468866593075817145448222552190081L,
            0.0013886192084085693220561019506202657094L,
            -0.00041774805176167946113270696447589167948L,
            -0.51036386876784775466031270024297899287e-4L,
            -0.19837378379115636070721132694392941892e-5L,
