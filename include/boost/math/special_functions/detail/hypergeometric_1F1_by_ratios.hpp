...
#include <boost/math/policies/error_handling.hpp>
  ...
  namespace boost { namespace math { namespace detail {
     ...
     template <class T>
     inline bool is_in_hypergeometric_1F1_from_function_ratio_negative_b_positive_a_region(const T& a, const T& b, const T& z)
     {
     ...
     template <class T, class Policy>
     T hypergeometric_1F1_from_function_ratio_negative_b_positive_a(const T& a, const T& b, const T& z, const Policy& pol, int& log_scaling)
     {
        //
