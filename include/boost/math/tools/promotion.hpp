  ...
  namespace math
  {
    namespace tools
    {
      ...
      struct promote_args
      {
         ...
         //
         BOOST_MATH_STATIC_ASSERT_MSG((0 == std::is_same<type, long double>::value), "Sorry, but this platform does not have sufficient long double support for the special functions to be reliably implemented.");
#endif
      };
