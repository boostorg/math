...
template <class T>
inline BOOST_CONSTEXPR T raise_domain_error(
           const char* ,
           const char* ,
           const T& ,
...
template <class T>
inline BOOST_CONSTEXPR T raise_pole_error(
           const char* function,
           const char* message,
           const T& val,
...
template <class T>
inline BOOST_CONSTEXPR T raise_overflow_error(
           const char* ,
           const char* ,
...
template <class T>
inline BOOST_CONSTEXPR T raise_underflow_error(
           const char* ,
           const char* ,
...
template <class T>
inline BOOST_CONSTEXPR T raise_denorm_error(
           const char* ,
           const char* ,
           const T&  val,
...
template <class T>
inline BOOST_CONSTEXPR T raise_evaluation_error(
           const char* ,
           const char* ,
           const T& val,
...
template <class T, class TargetType>
inline BOOST_CONSTEXPR TargetType raise_rounding_error(
           const char* ,
           const char* ,
           const T& val,
           const TargetType&,
...
template <class T, class R>
inline BOOST_CONSTEXPR T raise_indeterminate_result_error(
           const char* ,
           const char* ,
           const T& ,
           const R& result,
...
inline BOOST_CONSTEXPR T raise_domain_error(const char* function, const char* message, const T& val, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
template <class T, class Policy>
inline BOOST_CONSTEXPR T raise_pole_error(const char* function, const char* message, const T& val, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
template <class T, class Policy>
inline BOOST_CONSTEXPR T raise_overflow_error(const char* function, const char* message, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
template <class T, class Policy>
inline BOOST_CONSTEXPR T raise_overflow_error(const char* function, const char* message, const T& val, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
   typedef typename Policy::overflow_error_type policy_type;
...
template <class T, class Policy>
inline BOOST_CONSTEXPR T raise_underflow_error(const char* function, const char* message, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
template <class T, class Policy>
inline BOOST_CONSTEXPR T raise_denorm_error(const char* function, const char* message, const T& val, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
template <class T, class Policy>
inline BOOST_CONSTEXPR T raise_evaluation_error(const char* function, const char* message, const T& val, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
inline BOOST_CONSTEXPR TargetType raise_rounding_error(const char* function, const char* message, const T& val, const TargetType& t, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
inline BOOST_CONSTEXPR T raise_indeterminate_result_error(const char* function, const char* message, const T& val, const R& result, const Policy&) BOOST_NOEXCEPT_IF(is_noexcept_error_policy<Policy>::value && BOOST_MATH_IS_FLOAT(T))
{
...
inline BOOST_CONSTEXPR bool check_overflow(T /* val */, R* /* result */, const char* /* function */, const overflow_error<ignore_error>&) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T)) 
{ return false; }
template <class R, class T>
inline BOOST_CONSTEXPR bool check_overflow(std::complex<T> /* val */, R* /* result */, const char* /* function */, const overflow_error<ignore_error>&) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T)) 
{ return false; }
template <class R, class T>
inline BOOST_CONSTEXPR bool check_underflow(T /* val */, R* /* result */, const char* /* function */, const underflow_error<ignore_error>&) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T)) 
{ return false; }
template <class R, class T>
inline BOOST_CONSTEXPR bool check_underflow(std::complex<T> /* val */, R* /* result */, const char* /* function */, const underflow_error<ignore_error>&) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T)) 
{ return false; }
template <class R, class T>
inline BOOST_CONSTEXPR bool check_denorm(T /* val */, R* /* result*/, const char* /* function */, const denorm_error<ignore_error>&) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T)) 
{ return false; }
template <class R, class T>
inline BOOST_CONSTEXPR bool check_denorm(std::complex<T> /* val */, R* /* result*/, const char* /* function */, const denorm_error<ignore_error>&) BOOST_NOEXCEPT_IF(BOOST_MATH_IS_FLOAT(R) && BOOST_MATH_IS_FLOAT(T)) 
{ return false; }
