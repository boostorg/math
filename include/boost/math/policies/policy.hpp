...
template <class T>
BOOST_MATH_HOST_DEVICE constexpr int digits(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept;
template <class T>
BOOST_MATH_HOST_DEVICE constexpr T epsilon(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept(std::is_floating_point<T>::value);
...
BOOST_MATH_HOST_DEVICE constexpr policy<> make_policy() noexcept
{ return {}; }

template <class A1>
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1>::type make_policy(const A1&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2>::type make_policy(const A1&, const A2&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3>::type make_policy(const A1&, const A2&, const A3&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4>::type make_policy(const A1&, const A2&, const A3&, const A4&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4, A5>::type make_policy(const A1&, const A2&, const A3&, const A4&, const A5&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4, A5, A6>::type make_policy(const A1&, const A2&, const A3&, const A4&, const A5&, const A6&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7>::type make_policy(const A1&, const A2&, const A3&, const A4&, const A5&, const A6&, const A7&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8>::type make_policy(const A1&, const A2&, const A3&, const A4&, const A5&, const A6&, const A7&, const A8&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9>::type make_policy(const A1&, const A2&, const A3&, const A4&, const A5&, const A6&, const A7&, const A8&, const A9&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>::type make_policy(const A1&, const A2&, const A3&, const A4&, const A5&, const A6&, const A7&, const A8&, const A9&, const A10&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr typename normalise<policy<>, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11>::type make_policy(const A1&, const A2&, const A3&, const A4&, const A5&, const A6&, const A7&, const A8&, const A9&, const A10&, const A11&) noexcept
{
...
BOOST_MATH_HOST_DEVICE constexpr int digits_imp(std::true_type const&) noexcept
{
...
template <class T, class Policy>
BOOST_MATH_HOST_DEVICE constexpr int digits_imp(std::false_type const&) noexcept
{
...
template <class T, class Policy>
BOOST_MATH_HOST_DEVICE constexpr int digits_base10(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept
{
   return boost::math::policies::digits<T, Policy>() * 301 / 1000L;
}

template <class Policy>
BOOST_MATH_HOST_DEVICE constexpr unsigned long get_max_series_iterations() noexcept
{
...
template <class Policy>
BOOST_MATH_HOST_DEVICE constexpr unsigned long get_max_root_iterations() noexcept
{
...
{
   BOOST_MATH_HOST_DEVICE static T get() noexcept(std::is_floating_point<T>::value)
   {
...
{
   BOOST_MATH_HOST_DEVICE static constexpr T get() noexcept(std::is_floating_point<T>::value)
   {
...
template <class T, class Policy>
BOOST_MATH_HOST_DEVICE constexpr T get_epsilon_imp(std::true_type const&) noexcept(std::is_floating_point<T>::value)
{
   static_assert(std::numeric_limits<T>::is_specialized, "std::numeric_limits<T>::is_specialized");
...
template <class T, class Policy>
BOOST_MATH_HOST_DEVICE constexpr T get_epsilon_imp(std::false_type const&) noexcept(std::is_floating_point<T>::value)
{
...
template <class T, class Policy>
BOOST_MATH_HOST_DEVICE constexpr T get_epsilon(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept(std::is_floating_point<T>::value)
{
