...
namespace boost
{
  namespace math
  {
     ...
     namespace binomial_detail{
        ...
        template <class RealType, class Policy>
        BOOST_MATH_HOST_DEVICE inline bool check_N(const char* function, const RealType& N, RealType* result, const Policy& pol)
        {
        ...
        template <class RealType, class Policy>
        BOOST_MATH_HOST_DEVICE inline bool check_success_fraction(const char* function, const RealType& p, RealType* result, const Policy& pol)
        {
        ...
        template <class RealType, class Policy>
        BOOST_MATH_HOST_DEVICE inline bool check_dist(const char* function, const RealType& N, const RealType& p, RealType* result, const Policy& pol)
        {
        ...
        template <class RealType, class Policy>
        BOOST_MATH_HOST_DEVICE inline bool check_dist_and_k(const char* function, const RealType& N, const RealType& p, RealType k, RealType* result, const Policy& pol)
        {
        ...
        template <class RealType, class Policy>
        BOOST_MATH_HOST_DEVICE inline bool check_dist_and_prob(const char* function, const RealType& N, RealType p, RealType prob, RealType* result, const Policy& pol)
        {
         ...
         BOOST_MATH_HOST_DEVICE T inverse_binomial_cornish_fisher(T n, T sf, T p, T q, const Policy& pol)
         {
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE RealType quantile_imp(const binomial_distribution<RealType, Policy>& dist, const RealType& p, const RealType& q, bool comp)
    ...
    public:
      ...
      BOOST_MATH_HOST_DEVICE RealType success_fraction() const
      { // Probability.
        return m_p;
      }
      BOOST_MATH_HOST_DEVICE RealType trials() const
      ...
      //
      BOOST_MATH_HOST_DEVICE static RealType find_lower_bound_on_p(
         RealType trials,
         RealType successes,
      ...
      BOOST_MATH_HOST_DEVICE static RealType find_upper_bound_on_p(
         RealType trials,
         RealType successes,
         RealType probability,
         interval_type t = clopper_pearson_exact_interval)
      ...
      //
      BOOST_MATH_HOST_DEVICE static RealType find_minimum_number_of_trials(
      ...
      BOOST_MATH_HOST_DEVICE static RealType find_maximum_number_of_trials(
         RealType k,     // number of events
         RealType p,     // success fraction
         RealType alpha) // risk level
      {
    ...
    private:
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE const std::pair<RealType, RealType> range(const binomial_distribution<RealType, Policy>& dist)
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE const std::pair<RealType, RealType> support(const binomial_distribution<RealType, Policy>& dist)
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType mean(const binomial_distribution<RealType, Policy>& dist)
      { // Mean of Binomial distribution = np.
        return  dist.trials() * dist.success_fraction();
      } // mean

      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType variance(const binomial_distribution<RealType, Policy>& dist)
      { // Variance of Binomial distribution = np(1-p).
        return  dist.trials() * dist.success_fraction() * (1 - dist.success_fraction());
      } // variance

      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE RealType pdf(const binomial_distribution<RealType, Policy>& dist, const RealType& k)
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType cdf(const binomial_distribution<RealType, Policy>& dist, const RealType& k)
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType cdf(const complemented2_type<binomial_distribution<RealType, Policy>, RealType>& c)
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType quantile(const binomial_distribution<RealType, Policy>& dist, const RealType& p)
      {
         return binomial_detail::quantile_imp(dist, p, RealType(1-p), false);
      } // quantile

      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE RealType quantile(const complemented2_type<binomial_distribution<RealType, Policy>, RealType>& c)
      {
         return binomial_detail::quantile_imp(c.dist, RealType(1-c.param), c.param, true);
      } // quantile

      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType mode(const binomial_distribution<RealType, Policy>& dist)
      {
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType median(const binomial_distribution<RealType, Policy>& dist)
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType skewness(const binomial_distribution<RealType, Policy>& dist)
      {
         BOOST_MATH_STD_USING // ADL of std functions.
         RealType p = dist.success_fraction();
         RealType n = dist.trials();
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType kurtosis(const binomial_distribution<RealType, Policy>& dist)
      {
         RealType p = dist.success_fraction();
         RealType n = dist.trials();
      ...
      template <class RealType, class Policy>
      BOOST_MATH_HOST_DEVICE inline RealType kurtosis_excess(const binomial_distribution<RealType, Policy>& dist)
      {
         RealType p = dist.success_fraction();
         RealType q = 1 - p;
         RealType n = dist.trials();
