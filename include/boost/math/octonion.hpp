...
#define    BOOST_OCTONION_ACCESSOR_GENERATOR(type)                  \
        ...
        {                                                           \
            return(::std::complex<type>(g,h));                      \
                                                                    ...
                                                                    \
        ::boost::quaternion<type>    H_component_1() const          \
        {                                                           \
            return(::boost::quaternion<type>(a,b,c,d));             \
        }                                                           \
                                                                    \
        ::boost::quaternion<type>    H_component_2() const          \
        {                                                           \
            return(::boost::quaternion<type>(e,f,g,h));             \
        }
...
#define    BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(type)                                  \
        ...
        {                                                                                    \
            ...
            return(*this);                                                                   \
                                                                                             ...
                                                                                             \
        octonion<type> &        operator = (::boost::quaternion<type> const & a_affecter)    \
        {                                                                                    \
...
#define    BOOST_OCTONION_MEMBER_DATA_GENERATOR(type) \
    ...
    public:
        ...
        explicit                octonion(   ::boost::quaternion<T> const & q0,
                                            ::boost::quaternion<T> const & q1 = ::boost::quaternion<T>())
        :   a(q0.R_component_1()),
            b(q0.R_component_2()),
            c(q0.R_component_3()),
            d(q0.R_component_4()),
        ...
        octonion<T> &            operator += (::boost::quaternion<T> const & rhs)
        {
...
#define    BOOST_OCTONION_CONSTRUCTOR_GENERATOR(type)                                                               \
        ...
        {                                                                                                           \
                                                                                                                    ...
                                                                                                                    \
        explicit                    octonion(   ::boost::quaternion<type> const & q0,                               \
                                                ::boost::quaternion<type> const & q1 = ::boost::quaternion<type>()) \
        :   a(q0.R_component_1()),                                                                                  \
            b(q0.R_component_2()),                                                                                  \
            c(q0.R_component_3()),                                                                                  \
            d(q0.R_component_4()),                                                                                  \
...
#define    BOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)                                   \
        octonion<type> &            operator += (::boost::quaternion<type> const & rhs)  \
        {                                                                                \
            a += rhs.R_component_1();                                                    \
            b += rhs.R_component_2();                                                    \
            c += rhs.R_component_3();                                                    \
...
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)                                                                        \
    template<typename T>                                                                                                \
    inline octonion<T>                        operator op (::boost::quaternion<T> const & lhs, octonion<T> const & rhs)    \
    BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
    
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)                                                                        \
    template<typename T>                                                                                                \
    inline octonion<T>                        operator op (octonion<T> const & lhs, ::boost::quaternion<T> const & rhs)    \
    BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
...
#undef    BOOST_OCTONION_OPERATOR_GENERATOR_BODY
    ...
    template<typename T>
    inline bool                                operator == (::boost::quaternion<T> const & lhs, octonion<T> const & rhs)
    {
        return(
    ...
    template<typename T>
    inline bool                                operator == (octonion<T> const & lhs, ::boost::quaternion<T> const & rhs)
    {
        return(
...
#undef    BOOST_OCTONION_NOT_EQUAL_GENERATOR
                                                            ...
                                                            octonion<T> & o)
    {
        ...
        ::boost::quaternion<T>    p = ::boost::quaternion<T>();
        ::boost::quaternion<T>    q = ::boost::quaternion<T>();
                                    ...
                                    else if    (cc == ',')                            // read "((a),(c," or "((a),(e,"
                                    {
                                        ...
                                        else                                    // read "((a),(c,d" or "((a),(e,f"
                                        {
                                            ...
                                            else if    (cc == ',')                        // read "((a),(e,f," (ambiguity resolution)
                                            {
                                                ...
                                                if        (cc == ')')                        // read "((a),(e,f,g)"
                                                {
                                                    q = ::boost::quaternion<T>(c,d,g);        // "c" was actually "e", and "d" was actually "f"
                                                ...
                                                else if    (cc == ',')                        // read "((a),(e,f,g,"
                                                {
                                                    ...
                                                    {
                                                        q = ::boost::quaternion<T>(c,d,g,h);    // "c" was actually "e", and "d" was actually "f"
                                        ...
                                        else                                        // read "((a,b),(c" or "((a,b),(e"
                                        {
                                            ...
                                            else if    (cc == ',')                            // read "((a,b),(c," or "((a,b),(e,"
                                            {
                                                ...
                                                else                                        // read "((a,b),(c,d" or "((a,b),(e,f"
                                                {
                                                    ...
                                                    {
                                                        p = ::boost::quaternion<T>(a,b);                // too late to backtrack
                                                        ...
                                                        if        (cc == ')')                            // read "((a,b),(e,f,g)"
                                                        {
                                                            ...
                                                            if        (cc == ')')                            // read "((a,b),(e,f,g))"
                                                            {
                                                                q = ::boost::quaternion<T>(c,d,g);            // "c" is actually "e" and "d" is actually "f"
                                                        ...
                                                        else if    (cc == ',')                            // read "((a,b),(e,f,g,"
                                                        {
                                                            ...
                                                            if        (cc == ')')                            // read "((a,b),(e,f,g,h)"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read ((a,b),(e,f,g,h))"
                                                                {
                                                                    q = ::boost::quaternion<T>(c,d,g,h);            // "c" is actually "e" and "d" is actually "f"
