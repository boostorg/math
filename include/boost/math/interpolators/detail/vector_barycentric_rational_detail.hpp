...
{
public:
    vector_barycentric_rational_imp(std::vector<Real>&& x, std::vector<Real>&& y, size_t approximation_order = 3);
...
vector_barycentric_rational_imp<Real>::vector_barycentric_rational_imp(InputIterator1 start_x, InputIterator1 end_x, InputIterator2 start_y, size_t approximation_order)
{
...
template<class Real>
Real vector_barycentric_rational_imp<Real>::operator()(Real x) const
{
    Real numerator = 0;
    Real denominator = 0;
...
template <class RandomAccessContainer1, class RandomAccessContainer2>
Real vector_barycentric_rational_imp<Real>::prime(Real x) const
{
